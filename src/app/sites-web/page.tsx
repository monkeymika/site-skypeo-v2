              ...
              <motion.div
                ...
                style={
                  o.highlight
                    ? {
                        background:
                          "linear-gradient(135deg, #008f78 0%, #2b3475 100%)",
                      }
                    : {}
                }
              >
                ...
                <h3
                  className={`font-bebas mb-1 ${o.highlight ? "text-white" : "fg-1"}`}
                  style={{ fontSize: "clamp(1.5rem,2.5vw,2rem)" }}
                >
                  {o.name}
                </h3>
                <p
                  className={`text-xs mb-4 ${o.highlight ? "text-white/90" : "fg-3"}`}
                >
                  {o.desc}
                </p>
                <p
                  className={`font-bebas text-4xl mb-6 ${o.highlight ? "text-white" : "gradient-text"}`}
                >
                  {o.price}
                </p>
                <ul className="space-y-2.5 flex-1 mb-8">
                  {o.items.map((item) => (
                    <li
                      key={item}
                      className={`flex items-start gap-2.5 text-sm ${o.highlight ? "text-white/95" : "fg-3"}`}
                    >
                      <svg
                        className={`w-4 h-4 shrink-0 mt-0.5 ${o.highlight ? "text-white" : "text-[#008f78]"}`}
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
                ...
                <Link
                  ...
                  className={`block text-center px-6 py-3.5 rounded-xl font-semibold text-sm transition-all duration-200 hover:-translate-y-0.5 ${
                    o.highlight
                      ? "bg-white text-[#008f78] hover:bg-white/90"
                      : "btn-glow"
                  }`}
                >
