...
export default function ContactPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    const payload = {
      ...
      metier:     data.get("metier")   as string,
    ...
    <>
      ...
      <section className="relative pt-20 pb-16 px-5 sm:px-8 lg:px-10 overflow-hidden">
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 60% 50% at 30% 0%, rgba(123,47,190,0.15) 0%, transparent 65%)",
          }}
        />
        <div className="relative max-w-7xl mx-auto pt-40">
          ...
          <div className="grid lg:grid-cols-[1fr_1.4fr] gap-10 items-start">
            ...
            >
              {contactInfo.map((item) => (
                ...
                >
                  <div
                    className="w-10 h-10 rounded-xl flex items-center justify-center shrink-0 text-[#008f78]"
                    style={{
                      background: "rgba(0,143,120,0.10)",
                  ...
                  <div>
                    <p className="text-[10px] font-bold uppercase tracking-widest fg-4 mb-0.5">
                      {item.label}
                    </p>
                    {item.href ? (
                      <a
                        href={item.href}
                        className="text-sm font-semibold fg-1 hover:text-[#008f78] transition-colors"
                      >
                        {item.value}
                      </a>
                    ) : (
              ...
              >
                <p
                  className="font-bebas fg-1 mb-1"
                  style={{ fontSize: "1.5rem" }}
                >
                  AUDIT GRATUIT
                </p>
                <p className="text-sm fg-3 leading-relaxed">
                  On identifie ce qui vous vole du temps et on vous dit
                  exactement ce qu'on peut automatiser — sans engagement.
                </p>
              </motion.div>
            </motion.div>
              ...
              <div className="glass-card grad-border p-8 lg:p-10">
                {submitted ? (
                  <div className="text-center py-14">
                    ...
                    <h3
                      className="font-bebas fg-1 mb-2"
                      style={{ fontSize: "2rem" }}
                    >
                      MESSAGE ENVOYÉ !
                    </h3>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5" noValidate>
                    ...
                    <div className="grid sm:grid-cols-2 gap-4">
                      <div>
                        <label
                          htmlFor="name"
                          className="block text-[10px] font-bold uppercase tracking-[0.2em] fg-3 mb-2"
                        >
                          Nom complet *
                        </label>
                        <input
                          ...
                          className="w-full px-4 py-3.5 rounded-xl text-sm fg-1 placeholder:fg-5 focus:outline-none focus:ring-2 focus:ring-[#008f78]/30 transition-all duration-200"
                          style={{
                    ...
                    {/* Services */}
                    <div>
                      <p className="block text-[10px] font-bold uppercase tracking-[0.2em] fg-3 mb-2">
                          ...
                          <button
                            ...
                            style={
                              selected.includes(s.id)
                                ? {
                                    background:
                                      "linear-gradient(135deg, rgba(0,143,120,0.18), rgba(43,52,117,0.15))",
                                    border: "1px solid rgba(0,143,120,0.40)",
                                    color: "#008f78",
                                  }
                                : {
                                    background: "var(--subtle-bg)",
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        className="w-full px-4 py-3.5 rounded-xl text-sm fg-1 placeholder:fg-5 focus:outline-none focus:ring-2 focus:ring-[#008f78]/30 transition-all duration-200 resize-none"
                        style={{
                          background: "var(--subtle-bg)",
                          border: "1px solid var(--card-border)",
                        }}
                    ...
                    <button
                      type="submit"
                      disabled={loading}
                      className="btn-glow w-full py-4 disabled:opacity-60 disabled:cursor-not-allowed"
                    >
                      <span>
