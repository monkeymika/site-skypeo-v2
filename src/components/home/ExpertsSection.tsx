              ...
              <TiltCard className="group h-full" intensity={6}>
                <div className="glass-card grad-border p-8 relative overflow-hidden h-full">
                  ...
                  <div
                    ...
                    style={{
                      background: `radial-gradient(circle at 30% 40%, ${s.glow} 0%, transparent 60%)`,
                    }}
                  />
                  ...
                  <div className="relative">
                    ...
                    <div className="flex items-start justify-between mb-6">
                      <span className="font-bebas text-5xl gradient-text leading-none">
                        {s.n}
                      </span>
                      <Link
                        href={s.href}
                    ...
                    <p
                      className="font-bebas fg-3 mb-5"
                      style={{ fontSize: "clamp(1.5rem, 2.5vw, 2rem)" }}
                    >
                      {s.sub}
                    </p>
                    <p className="text-sm fg-3 leading-relaxed mb-6">
                      {s.desc}
                    </p>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {s.tags.map((t) => (
                        <span
                          ...
                          style={{
                            border: "1px solid rgba(0,143,120,0.30)",
                            color: "#008f78",
                          }}
                        >
                          {t}
