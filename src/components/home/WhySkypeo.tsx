...
export function WhySkypeo() {
  ...
  return (
    <section
      ref={sectionRef}
      className="py-24 px-5 sm:px-8 lg:px-10 relative overflow-hidden"
    >
      {/* Decorative glow */}
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 50% 60% at 100% 50%, rgba(43,52,117,0.07) 0%, transparent 60%)",
        }}
      />
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="why-heading mb-20">
          ...
          <div className="overflow-hidden">
            <div
              className="why-line font-bebas fg-1 block"
          ...
          <div className="overflow-hidden">
            <div
              className="why-line font-bebas block"
              style={{ fontSize: "clamp(1.5rem, 6vw, 5rem)" }}
            >
          ...
          {reasons.map((r) => (
            ...
            >
              ...
              <div
                ...
                style={{
                  background: `radial-gradient(ellipse 40% 100% at 0% 50%, ${r.glow} 0%, transparent 70%)`,
                }}
              />

              {/* Number */}
              <div className="col-span-2 sm:col-span-1">
                <span className="why-number font-bebas text-3xl sm:text-4xl gradient-text">
                  {r.n}
                </span>
              </div>
